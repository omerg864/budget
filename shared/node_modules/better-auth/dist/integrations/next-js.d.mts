...
declare const nextCookies: () => {
  ...
  hooks: {
    after: {
      matcher(ctx: _better_auth_core4.HookEndpointContext): true;
      handler: (inputContext: better_call179.MiddlewareInputContext<better_call179.MiddlewareOptions>) => Promise<void>;
    }[];
  };
};
//#endregion
