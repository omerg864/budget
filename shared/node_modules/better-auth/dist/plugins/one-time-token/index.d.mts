...
declare const oneTimeToken: (options?: OneTimeTokenOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateOneTimeToken: better_call233.StrictEndpoint<"/one-time-token/generate", {
      method: "GET";
      use: ((inputContext: better_call233.MiddlewareInputContext<better_call233.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    verifyOneTimeToken: better_call233.StrictEndpoint<"/one-time-token/verify", {
      method: "POST";
      body: z.ZodObject<{
        token: z.ZodString;
      }, z.core.$strip>;
