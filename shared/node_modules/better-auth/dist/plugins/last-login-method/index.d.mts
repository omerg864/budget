...
import * as better_call697 from "better-call";
...
declare const lastLoginMethod: <O extends LastLoginMethodOptions>(userConfig?: O | undefined) => {
  ...
  init(ctx: _better_auth_core33.AuthContext): {
    options: {
      databaseHooks: {
        user: {
          create: {
  ...
  hooks: {
    after: {
      matcher(): true;
      handler: (inputContext: better_call697.MiddlewareInputContext<better_call697.MiddlewareOptions>) => Promise<void>;
    }[];
  };
