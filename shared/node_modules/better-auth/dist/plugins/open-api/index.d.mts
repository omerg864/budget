...
import * as better_call177 from "better-call";
...
declare const openAPI: <O extends OpenAPIOptions>(options?: O | undefined) => {
  id: "open-api";
  endpoints: {
    generateOpenAPISchema: better_call177.StrictEndpoint<"/open-api/generate-schema", {
      method: "GET";
    }, {
      openapi: string;
      info: {
    ...
    openAPIReference: better_call177.StrictEndpoint<"/reference", {
      method: "GET";
      metadata: {
