...
import * as better_call181 from "better-call";
...
declare const oAuthProxy: <O extends OAuthProxyOptions>(opts?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    oAuthProxy: better_call181.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call181.MiddlewareInputContext<better_call181.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call181.MiddlewareInputContext<better_call181.MiddlewareOptions>) => Promise<void>;
    }[];
    after: {
      matcher(context: _better_auth_core5.HookEndpointContext): boolean;
      handler: (inputContext: better_call181.MiddlewareInputContext<better_call181.MiddlewareOptions>) => Promise<void>;
