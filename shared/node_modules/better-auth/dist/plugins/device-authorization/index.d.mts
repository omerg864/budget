...
declare const deviceAuthorization: (options?: Partial<DeviceAuthorizationOptions>) => {
  ...
  endpoints: {
    deviceCode: better_call201.StrictEndpoint<"/device/code", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceToken: better_call201.StrictEndpoint<"/device/token", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceVerify: better_call201.StrictEndpoint<"/device", {
      method: "GET";
      query: z.ZodObject<{
    ...
    deviceApprove: better_call201.StrictEndpoint<"/device/approve", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceDeny: better_call201.StrictEndpoint<"/device/deny", {
      method: "POST";
      body: z.ZodObject<{
        userCode: z.ZodString;
      }, z.core.$strip>;
