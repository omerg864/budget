...
declare const createHasPermission: <O extends OrganizationOptions>(options: O) => better_call740.StrictEndpoint<"/organization/has-permission", {
  method: "POST";
  requireHeaders: true;
  ...
  use: ((inputContext: better_call740.MiddlewareInputContext<{
    use: ((inputContext: better_call740.MiddlewareInputContext<better_call740.MiddlewareOptions>) => Promise<{
      session: {
