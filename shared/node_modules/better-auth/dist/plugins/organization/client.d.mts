...
import * as _better_auth_core34 from "@better-auth/core";
...
declare const organizationClient: <CO extends OrganizationClientOptions>(options?: CO | undefined) => {
  ...
  getActions: ($fetch: _better_fetch_fetch112.BetterFetch, _$store: _better_auth_core34.ClientStore, co: _better_auth_core34.BetterAuthClientOptions | undefined) => {
    $Infer: {
