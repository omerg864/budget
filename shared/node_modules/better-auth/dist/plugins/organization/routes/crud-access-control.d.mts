...
import "../../index.mjs";
import * as _better_auth_core_db146 from "@better-auth/core/db";
import * as z from "zod";
import * as better_call992 from "better-call";
...
declare const createOrgRole: <O extends OrganizationOptions>(options: O) => better_call992.StrictEndpoint<"/organization/create-role", {
  method: "POST";
  body: z.ZodObject<{
  ...
  requireHeaders: true;
  use: ((inputContext: better_call992.MiddlewareInputContext<{
    use: ((inputContext: better_call992.MiddlewareInputContext<better_call992.MiddlewareOptions>) => Promise<{
      session: {
    ...
    session: {
      session: _better_auth_core_db146.Session & {
...
declare const deleteOrgRole: <O extends OrganizationOptions>(options: O) => better_call992.StrictEndpoint<"/organization/delete-role", {
  method: "POST";
...
declare const listOrgRoles: <O extends OrganizationOptions>(options: O) => better_call992.StrictEndpoint<"/organization/list-roles", {
  method: "GET";
  requireHeaders: true;
  use: ((inputContext: better_call992.MiddlewareInputContext<{
    use: ((inputContext: better_call992.MiddlewareInputContext<better_call992.MiddlewareOptions>) => Promise<{
...
declare const getOrgRole: <O extends OrganizationOptions>(options: O) => better_call992.StrictEndpoint<"/organization/get-role", {
  method: "GET";
  requireHeaders: true;
  use: ((inputContext: better_call992.MiddlewareInputContext<{
    use: ((inputContext: better_call992.MiddlewareInputContext<better_call992.MiddlewareOptions>) => Promise<{
...
declare const updateOrgRole: <O extends OrganizationOptions>(options: O) => better_call992.StrictEndpoint<"/organization/update-role", {
  method: "POST";
  body: z.ZodIntersection<z.ZodObject<{
    organizationId: z.ZodOptional<z.ZodString>;
    data: z.ZodObject<{
