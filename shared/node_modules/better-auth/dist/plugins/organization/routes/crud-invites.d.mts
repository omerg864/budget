...
import "../index.mjs";
import * as _better_auth_core64 from "@better-auth/core";
import * as _better_auth_core_db122 from "@better-auth/core/db";
import * as z from "zod";
import * as better_call956 from "better-call";

//#region src/plugins/organization/routes/crud-invites.d.ts
declare const createInvitation: <O extends OrganizationOptions>(option: O) => better_call956.StrictEndpoint<"/organization/invite-member", {
  method: "POST";
  requireHeaders: true;
  use: (((inputContext: better_call956.MiddlewareInputContext<better_call956.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
      [key: string]: Role<{}>;
    };
    getSession: (context: _better_auth_core64.GenericEndpointContext) => Promise<{
      session: _better_auth_core_db122.Session & {
        activeTeamId?: string | undefined;
        activeOrganizationId?: string | undefined;
      };
      user: _better_auth_core_db122.User;
    }>;
  }>) | ((inputContext: better_call956.MiddlewareInputContext<{
    use: ((inputContext: better_call956.MiddlewareInputContext<better_call956.MiddlewareOptions>) => Promise<{
      session: {
...
declare const acceptInvitation: <O extends OrganizationOptions>(options: O) => better_call956.StrictEndpoint<"/organization/accept-invitation", {
  method: "POST";
  body: z.ZodObject<{
...
declare const rejectInvitation: <O extends OrganizationOptions>(options: O) => better_call956.StrictEndpoint<"/organization/reject-invitation", {
  method: "POST";
  body: z.ZodObject<{
    invitationId: z.ZodString;
  }, z.core.$strip>;
...
declare const cancelInvitation: <O extends OrganizationOptions>(options: O) => better_call956.StrictEndpoint<"/organization/cancel-invitation", {
  method: "POST";
  body: z.ZodObject<{
    invitationId: z.ZodString;
  }, z.core.$strip>;
...
declare const getInvitation: <O extends OrganizationOptions>(options: O) => better_call956.StrictEndpoint<"/organization/get-invitation", {
  method: "GET";
  use: ((inputContext: better_call956.MiddlewareInputContext<better_call956.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const listInvitations: <O extends OrganizationOptions>(options: O) => better_call956.StrictEndpoint<"/organization/list-invitations", {
  method: "GET";
  requireHeaders: true;
  use: (((inputContext: better_call956.MiddlewareInputContext<better_call956.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
 ...
 */
declare const listUserInvitations: <O extends OrganizationOptions>(options: O) => better_call956.StrictEndpoint<"/organization/list-user-invitations", {
  method: "GET";
  use: ((inputContext: better_call956.MiddlewareInputContext<better_call956.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
