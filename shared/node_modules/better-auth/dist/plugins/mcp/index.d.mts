...
import * as better_call667 from "better-call";
...
declare const mcp: (options: MCPOptions) => {
  ...
  hooks: {
    after: {
      matcher(): true;
      handler: (inputContext: better_call667.MiddlewareInputContext<better_call667.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  endpoints: {
    oAuthConsent: better_call667.StrictEndpoint<"/oauth2/consent", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        accept: z.ZodBoolean;
      ...
      use: ((inputContext: better_call667.MiddlewareInputContext<better_call667.MiddlewareOptions>) => Promise<{
        session: {
    ...
    getMcpOAuthConfig: better_call667.StrictEndpoint<"/.well-known/oauth-authorization-server", {
      method: "GET";
      metadata: {
        readonly scope: "server";
      };
    }, OIDCMetadata | null>;
    getMCPProtectedResource: better_call667.StrictEndpoint<"/.well-known/oauth-protected-resource", {
      method: "GET";
      metadata: {
        readonly scope: "server";
      };
    ...
    mcpOAuthAuthorize: better_call667.StrictEndpoint<"/mcp/authorize", {
      method: "GET";
    ...
    mcpOAuthToken: better_call667.StrictEndpoint<"/mcp/token", {
      method: "POST";
    ...
    registerMcpClient: better_call667.StrictEndpoint<"/mcp/register", {
      method: "POST";
      body: z.ZodObject<{
    ...
    getMcpSession: better_call667.StrictEndpoint<"/mcp/get-session", {
      method: "GET";
      requireHeaders: true;
