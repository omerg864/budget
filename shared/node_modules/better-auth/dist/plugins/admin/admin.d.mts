...
import * as _better_auth_core_db20 from "@better-auth/core/db";
import * as zod1922 from "zod";
import * as better_call699 from "better-call";
...
declare const admin: <O extends AdminOptions>(options?: O | undefined) => {
      ...
      databaseHooks: {
        ...
        session: {
          create: {
            ...
            } & Record<string, unknown>, ctx: _better_auth_core37.GenericEndpointContext | null): Promise<void>;
          };
        };
      };
    };
  ...
  hooks: {
    after: {
      matcher(context: _better_auth_core37.HookEndpointContext): boolean;
      handler: (inputContext: better_call699.MiddlewareInputContext<better_call699.MiddlewareOptions>) => Promise<SessionWithImpersonatedBy[] | undefined>;
    }[];
  };
  endpoints: {
    setRole: better_call699.StrictEndpoint<"/admin/set-role", {
      method: "POST";
      ...
      requireHeaders: true;
      use: ((inputContext: better_call699.MiddlewareInputContext<better_call699.MiddlewareOptions>) => Promise<{
        session: {
          user: UserWithRole;
          session: _better_auth_core_db20.Session;
        };
      }>)[];
      metadata: {
        openapi: {
    ...
    getUser: better_call699.StrictEndpoint<"/admin/get-user", {
      method: "GET";
    ...
    createUser: better_call699.StrictEndpoint<"/admin/create-user", {
      method: "POST";
      body: zod1922.ZodObject<{
        email: zod1922.ZodString;
        password: zod1922.ZodString;
    ...
    adminUpdateUser: better_call699.StrictEndpoint<"/admin/update-user", {
      method: "POST";
      body: zod1922.ZodObject<{
        userId: zod1922.ZodCoercedString<unknown>;
    ...
    listUsers: better_call699.StrictEndpoint<"/admin/list-users", {
      method: "GET";
      use: ((inputContext: better_call699.MiddlewareInputContext<better_call699.MiddlewareOptions>) => Promise<{
        session: {
          user: UserWithRole;
    ...
    listUserSessions: better_call699.StrictEndpoint<"/admin/list-user-sessions", {
      method: "POST";
      use: ((inputContext: better_call699.MiddlewareInputContext<better_call699.MiddlewareOptions>) => Promise<{
        session: {
          user: UserWithRole;
    ...
    unbanUser: better_call699.StrictEndpoint<"/admin/unban-user", {
      method: "POST";
      body: zod1922.ZodObject<{
        userId: zod1922.ZodCoercedString<unknown>;
      }, zod_v4_core268.$strip>;
    ...
    banUser: better_call699.StrictEndpoint<"/admin/ban-user", {
      method: "POST";
      body: zod1922.ZodObject<{
        userId: zod1922.ZodCoercedString<unknown>;
    ...
    impersonateUser: better_call699.StrictEndpoint<"/admin/impersonate-user", {
      method: "POST";
      body: zod1922.ZodObject<{
        userId: zod1922.ZodCoercedString<unknown>;
      }, zod_v4_core268.$strip>;
    ...
    stopImpersonating: better_call699.StrictEndpoint<"/admin/stop-impersonating", {
      method: "POST";
      requireHeaders: true;
    }, {
      session: _better_auth_core_db20.Session & Record<string, any>;
      user: _better_auth_core_db20.User & Record<string, any>;
    }>;
    revokeUserSession: better_call699.StrictEndpoint<"/admin/revoke-user-session", {
      method: "POST";
      body: zod1922.ZodObject<{
    ...
    revokeUserSessions: better_call699.StrictEndpoint<"/admin/revoke-user-sessions", {
      method: "POST";
      body: zod1922.ZodObject<{
        userId: zod1922.ZodCoercedString<unknown>;
      }, zod_v4_core268.$strip>;
    ...
    removeUser: better_call699.StrictEndpoint<"/admin/remove-user", {
      method: "POST";
      body: zod1922.ZodObject<{
        userId: zod1922.ZodCoercedString<unknown>;
      }, zod_v4_core268.$strip>;
    ...
    setUserPassword: better_call699.StrictEndpoint<"/admin/set-user-password", {
      method: "POST";
      body: zod1922.ZodObject<{
    ...
    userHasPermission: better_call699.StrictEndpoint<"/admin/has-permission", {
      method: "POST";
