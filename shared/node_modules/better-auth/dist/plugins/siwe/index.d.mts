...
import * as better_call199 from "better-call";
...
declare const siwe: (options: SIWEPluginOptions) => {
  ...
  endpoints: {
    getSiweNonce: better_call199.StrictEndpoint<"/siwe/nonce", {
      method: "POST";
      body: z.ZodObject<{
    ...
    verifySiweMessage: better_call199.StrictEndpoint<"/siwe/verify", {
      method: "POST";
      body: z.ZodObject<{
        message: z.ZodString;
