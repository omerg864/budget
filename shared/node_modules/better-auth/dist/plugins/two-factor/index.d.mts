...
declare const twoFactor: <O extends TwoFactorOptions>(options?: O) => {
  ...
  endpoints: {
     ...
     */
    enableTwoFactor: better_call239.StrictEndpoint<"/two-factor/enable", {
      method: "POST";
      body: z.ZodObject<{
        password: z.ZodString;
        issuer: z.ZodOptional<z.ZodString>;
      }, z.core.$strip>;
      use: ((inputContext: better_call239.MiddlewareInputContext<better_call239.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    disableTwoFactor: better_call239.StrictEndpoint<"/two-factor/disable", {
      method: "POST";
      body: z.ZodObject<{
        password: z.ZodString;
      }, z.core.$strip>;
    ...
    verifyBackupCode: better_call239.StrictEndpoint<"/two-factor/verify-backup-code", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
    ...
    generateBackupCodes: better_call239.StrictEndpoint<"/two-factor/generate-backup-codes", {
      method: "POST";
      body: z.ZodObject<{
        password: z.ZodString;
      }, z.core.$strip>;
    ...
    viewBackupCodes: better_call239.StrictEndpoint<string, {
      method: "POST";
      body: z.ZodObject<{
    ...
    sendTwoFactorOTP: better_call239.StrictEndpoint<"/two-factor/send-otp", {
      method: "POST";
    ...
    verifyTwoFactorOTP: better_call239.StrictEndpoint<"/two-factor/verify-otp", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
        trustDevice: z.ZodOptional<z.ZodBoolean>;
    ...
    generateTOTP: better_call239.StrictEndpoint<string, {
      method: "POST";
      body: z.ZodObject<{
        secret: z.ZodString;
      }, z.core.$strip>;
    ...
    getTOTPURI: better_call239.StrictEndpoint<"/two-factor/get-totp-uri", {
      method: "POST";
      use: ((inputContext: better_call239.MiddlewareInputContext<better_call239.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    verifyTOTP: better_call239.StrictEndpoint<"/two-factor/verify-totp", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
        trustDevice: z.ZodOptional<z.ZodBoolean>;
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call239.MiddlewareInputContext<better_call239.MiddlewareOptions>) => Promise<{
