...
import * as better_call744 from "better-call";
...
declare const backupCode2fa: (opts: BackupCodeOptions) => {
  ...
  endpoints: {
     ...
     */
    verifyBackupCode: better_call744.StrictEndpoint<"/two-factor/verify-backup-code", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
     ...
     */
    generateBackupCodes: better_call744.StrictEndpoint<"/two-factor/generate-backup-codes", {
      method: "POST";
      body: z.ZodObject<{
        password: z.ZodString;
      }, z.core.$strip>;
      use: ((inputContext: better_call744.MiddlewareInputContext<better_call744.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    viewBackupCodes: better_call744.StrictEndpoint<string, {
      method: "POST";
      body: z.ZodObject<{
