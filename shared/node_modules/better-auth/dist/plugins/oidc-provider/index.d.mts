...
import * as better_call218 from "better-call";
...
declare const oidcProvider: (options: OIDCOptions) => {
  ...
  hooks: {
    after: {
      matcher(): true;
      handler: (inputContext: better_call218.MiddlewareInputContext<better_call218.MiddlewareOptions>) => Promise<Response | {
        redirect: boolean;
        url: string;
      } | undefined>;
    }[];
  ...
  endpoints: {
    getOpenIdConfig: better_call218.StrictEndpoint<"/.well-known/openid-configuration", {
      method: "GET";
      operationId: string;
      metadata: {
    ...
    oAuth2authorize: better_call218.StrictEndpoint<"/oauth2/authorize", {
      method: "GET";
      operationId: string;
    ...
    oAuthConsent: better_call218.StrictEndpoint<"/oauth2/consent", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        accept: z.ZodBoolean;
      ...
      use: ((inputContext: better_call218.MiddlewareInputContext<better_call218.MiddlewareOptions>) => Promise<{
        session: {
    ...
    oAuth2token: better_call218.StrictEndpoint<"/oauth2/token", {
      method: "POST";
      operationId: string;
    ...
    oAuth2userInfo: better_call218.StrictEndpoint<"/oauth2/userinfo", {
      method: "GET";
      operationId: string;
      metadata: {
        openapi: {
     ...
     */
    registerOAuthApplication: better_call218.StrictEndpoint<"/oauth2/register", {
      method: "POST";
      body: z.ZodObject<{
    ...
    getOAuthClient: better_call218.StrictEndpoint<"/oauth2/client/:id", {
      method: "GET";
      use: ((inputContext: better_call218.MiddlewareInputContext<better_call218.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
     ...
     */
    endSession: better_call218.StrictEndpoint<"/oauth2/endsession", {
      method: ("GET" | "POST")[];
      ...
      status: ("OK" | "CREATED" | "ACCEPTED" | "NO_CONTENT" | "MULTIPLE_CHOICES" | "MOVED_PERMANENTLY" | "FOUND" | "SEE_OTHER" | "NOT_MODIFIED" | "TEMPORARY_REDIRECT" | "BAD_REQUEST" | "UNAUTHORIZED" | "PAYMENT_REQUIRED" | "FORBIDDEN" | "NOT_FOUND" | "METHOD_NOT_ALLOWED" | "NOT_ACCEPTABLE" | "PROXY_AUTHENTICATION_REQUIRED" | "REQUEST_TIMEOUT" | "CONFLICT" | "GONE" | "LENGTH_REQUIRED" | "PRECONDITION_FAILED" | "PAYLOAD_TOO_LARGE" | "URI_TOO_LONG" | "UNSUPPORTED_MEDIA_TYPE" | "RANGE_NOT_SATISFIABLE" | "EXPECTATION_FAILED" | "I'M_A_TEAPOT" | "MISDIRECTED_REQUEST" | "UNPROCESSABLE_ENTITY" | "LOCKED" | "FAILED_DEPENDENCY" | "TOO_EARLY" | "UPGRADE_REQUIRED" | "PRECONDITION_REQUIRED" | "TOO_MANY_REQUESTS" | "REQUEST_HEADER_FIELDS_TOO_LARGE" | "UNAVAILABLE_FOR_LEGAL_REASONS" | "INTERNAL_SERVER_ERROR" | "NOT_IMPLEMENTED" | "BAD_GATEWAY" | "SERVICE_UNAVAILABLE" | "GATEWAY_TIMEOUT" | "HTTP_VERSION_NOT_SUPPORTED" | "VARIANT_ALSO_NEGOTIATES" | "INSUFFICIENT_STORAGE" | "LOOP_DETECTED" | "NOT_EXTENDED" | "NETWORK_AUTHENTICATION_REQUIRED") | better_call218.Status;
      body: ({
        message?: string;
        code?: string;
        cause?: unknown;
  ...
  readonly options: {
    ...
    getAdditionalUserInfoClaim?: ((user: _better_auth_core_db6.User & Record<string, any>, scopes: string[], client: Client) => Record<string, any> | Promise<Record<string, any>>) | undefined;
