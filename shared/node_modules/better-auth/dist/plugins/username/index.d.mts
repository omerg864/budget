...
import * as _better_auth_core_db4 from "@better-auth/core/db";
...
declare const username: (options?: UsernameOptions | undefined) => {
      ...
      databaseHooks: {
        user: {
          create: {
            ...
            } & Record<string, unknown>, context: _better_auth_core8.GenericEndpointContext | null): Promise<{
              data: {
  ...
  endpoints: {
    signInUsername: better_call195.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call195.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
    ...
    user: {
      fields: {
        username: {
          ...
          returned: true;
          transform: {
            input(value: _better_auth_core_db4.DBPrimitive): string | number | boolean | Date | unknown[] | Record<string, unknown> | null | undefined;
          };
        };
        displayUsername: {
          type: "string";
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call195.MiddlewareInputContext<better_call195.MiddlewareOptions>) => Promise<void>;
    }[];
  };
