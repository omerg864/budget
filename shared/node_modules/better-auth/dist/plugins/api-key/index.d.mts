...
import * as better_call678 from "better-call";
...
declare const apiKey: (options?: ApiKeyOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call678.MiddlewareInputContext<better_call678.MiddlewareOptions>) => Promise<{
        user: {
          id: string;
          createdAt: Date;
          updatedAt: Date;
        ...
        context: better_call678.MiddlewareContext<better_call678.MiddlewareOptions, {
          returned?: unknown | undefined;
          responseHeaders?: Headers | undefined;
        } & _better_auth_core23.PluginContext & {
          ...
          newSession: {
            session: _better_auth_core_db9.Session & Record<string, any>;
            user: _better_auth_core_db9.User & Record<string, any>;
          } | null;
          session: {
            session: _better_auth_core_db9.Session & Record<string, any>;
            user: _better_auth_core_db9.User & Record<string, any>;
          ...
          } & _better_auth_core23.BetterAuthRateLimitOptions;
          ...
          createAuthCookie: (cookieName: string, overrideAttributes?: Partial<better_call678.CookieOptions> | undefined) => {
            name: string;
            attributes: better_call678.CookieOptions;
          };
          secret: string;
          sessionConfig: {
            updateAge: number;
          ...
          generateId: (options: {
            model: _better_auth_core_db9.ModelNames;
            size?: number | undefined;
          }) => string | false;
          secondaryStorage: _better_auth_core_db9.SecondaryStorage | undefined;
          password: {
          ...
          tables: _better_auth_core_db9.BetterAuthDBSchema;
  ...
  endpoints: {
     ...
     */
    createApiKey: better_call678.StrictEndpoint<"/api-key/create", {
      method: "POST";
     ...
     */
    verifyApiKey: better_call678.StrictEndpoint<string, {
      method: "POST";
      body: zod1848.ZodObject<{
     ...
     */
    getApiKey: better_call678.StrictEndpoint<"/api-key/get", {
      method: "GET";
      query: zod1848.ZodObject<{
        id: zod1848.ZodString;
      }, zod_v4_core263.$strip>;
      use: ((inputContext: better_call678.MiddlewareInputContext<better_call678.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    updateApiKey: better_call678.StrictEndpoint<"/api-key/update", {
      method: "POST";
      body: zod1848.ZodObject<{
     ...
     */
    deleteApiKey: better_call678.StrictEndpoint<"/api-key/delete", {
      method: "POST";
      body: zod1848.ZodObject<{
        keyId: zod1848.ZodString;
      }, zod_v4_core263.$strip>;
     ...
     */
    listApiKeys: better_call678.StrictEndpoint<"/api-key/list", {
      method: "GET";
      use: ((inputContext: better_call678.MiddlewareInputContext<better_call678.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
     ...
     */
    deleteAllExpiredApiKeys: better_call678.StrictEndpoint<string, {
      method: "POST";
    }, {
      success: boolean;
      error: unknown;
    ...
    apikey: {
      fields: {
        ...
        metadata: {
          ...
          input: true;
          transform: {
            input(value: _better_auth_core_db9.DBPrimitive): string;
            output(value: _better_auth_core_db9.DBPrimitive): any;
          };
        };
      };
    };
