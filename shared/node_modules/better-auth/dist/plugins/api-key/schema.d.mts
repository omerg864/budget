import * as _better_auth_core_db151 from "@better-auth/core/db";
  ...
  apikey: {
    fields: {
      ...
      metadata: {
        ...
        input: true;
        transform: {
          input(value: _better_auth_core_db151.DBPrimitive): string;
          output(value: _better_auth_core_db151.DBPrimitive): any;
        };
      };
    };
  };
