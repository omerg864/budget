...
import * as better_call208 from "better-call";

//#region src/plugins/anonymous/index.d.ts
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call208.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
    ...
    deleteAnonymousUser: better_call208.StrictEndpoint<"/delete-anonymous-user", {
      method: "POST";
      use: ((inputContext: better_call208.MiddlewareInputContext<better_call208.MiddlewareOptions>) => Promise<{
        session: {
  ...
  hooks: {
    after: {
      matcher(ctx: _better_auth_core16.HookEndpointContext): boolean;
      handler: (inputContext: better_call208.MiddlewareInputContext<better_call208.MiddlewareOptions>) => Promise<void>;
    }[];
  };
