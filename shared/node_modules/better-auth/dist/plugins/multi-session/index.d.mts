...
declare const multiSession: (options?: MultiSessionConfig | undefined) => {
  ...
  endpoints: {
     ...
     */
    listDeviceSessions: better_call167.StrictEndpoint<"/multi-session/list-device-sessions", {
      method: "GET";
      requireHeaders: true;
    }, {
     ...
     */
    setActiveSession: better_call167.StrictEndpoint<"/multi-session/set-active", {
      method: "POST";
      body: z.ZodObject<{
     ...
     */
    revokeDeviceSession: better_call167.StrictEndpoint<"/multi-session/revoke", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call167.MiddlewareInputContext<better_call167.MiddlewareOptions>) => Promise<void>;
    }[];
  };
