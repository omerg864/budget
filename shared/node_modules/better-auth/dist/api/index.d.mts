...
import * as better_call14 from "better-call";
...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Awaitable<AuthContext>, options: Option): {
  api: {
    readonly ok: better_call14.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call14.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call14.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
    ...
    readonly callbackOAuth: better_call14.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
      body: zod24.ZodOptional<zod24.ZodObject<{
        code: zod24.ZodOptional<zod24.ZodString>;
        error: zod24.ZodOptional<zod24.ZodString>;
        device_id: zod24.ZodOptional<zod24.ZodString>;
        error_description: zod24.ZodOptional<zod24.ZodString>;
        state: zod24.ZodOptional<zod24.ZodString>;
        user: zod24.ZodOptional<zod24.ZodString>;
      }, zod_v4_core7.$strip>>;
      query: zod24.ZodOptional<zod24.ZodObject<{
        code: zod24.ZodOptional<zod24.ZodString>;
        error: zod24.ZodOptional<zod24.ZodString>;
        device_id: zod24.ZodOptional<zod24.ZodString>;
        error_description: zod24.ZodOptional<zod24.ZodString>;
    ...
    readonly getSession: better_call14.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: zod24.ZodOptional<zod24.ZodObject<{
        disableCookieCache: zod24.ZodOptional<zod24.ZodCoercedBoolean<unknown>>;
        disableRefresh: zod24.ZodOptional<zod24.ZodCoercedBoolean<unknown>>;
      }, zod_v4_core7.$strip>>;
      requireHeaders: true;
      metadata: {
        openapi: {
    ...
    readonly signOut: better_call14.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call14.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<void>)[];
      body: zod24.ZodIntersection<zod24.ZodObject<{
        name: zod24.ZodString;
        email: zod24.ZodEmail;
        password: zod24.ZodString;
        image: zod24.ZodOptional<zod24.ZodString>;
        callbackURL: zod24.ZodOptional<zod24.ZodString>;
        rememberMe: zod24.ZodOptional<zod24.ZodBoolean>;
      }, zod_v4_core7.$strip>, zod24.ZodRecord<zod24.ZodString, zod24.ZodAny>>;
      metadata: {
        allowedMediaTypes: string[];
        $Infer: {
          body: {
    ...
    readonly signInEmail: better_call14.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<void>)[];
      body: zod24.ZodObject<{
        email: zod24.ZodString;
        password: zod24.ZodString;
        callbackURL: zod24.ZodOptional<zod24.ZodString>;
        rememberMe: zod24.ZodOptional<zod24.ZodDefault<zod24.ZodBoolean>>;
      }, zod_v4_core7.$strip>;
      metadata: {
        allowedMediaTypes: string[];
        $Infer: {
    ...
    readonly resetPassword: better_call14.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: zod24.ZodOptional<zod24.ZodObject<{
        token: zod24.ZodOptional<zod24.ZodString>;
      }, zod_v4_core7.$strip>>;
      body: zod24.ZodObject<{
        newPassword: zod24.ZodString;
        token: zod24.ZodOptional<zod24.ZodString>;
      }, zod_v4_core7.$strip>;
      metadata: {
        openapi: {
    ...
    readonly verifyPassword: better_call14.StrictEndpoint<"/verify-password", {
      method: "POST";
      body: zod24.ZodObject<{
        password: zod24.ZodString;
      }, zod_v4_core7.$strip>;
      ...
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly verifyEmail: better_call14.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
    ...
    readonly sendVerificationEmail: better_call14.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: zod24.ZodObject<{
        email: zod24.ZodEmail;
    ...
    readonly changeEmail: better_call14.StrictEndpoint<"/change-email", {
      method: "POST";
      body: zod24.ZodObject<{
        newEmail: zod24.ZodEmail;
        callbackURL: zod24.ZodOptional<zod24.ZodString>;
      }, zod_v4_core7.$strip>;
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly changePassword: better_call14.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: zod24.ZodObject<{
        newPassword: zod24.ZodString;
        currentPassword: zod24.ZodString;
        revokeOtherSessions: zod24.ZodOptional<zod24.ZodBoolean>;
      }, zod_v4_core7.$strip>;
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly setPassword: better_call14.StrictEndpoint<string, {
      method: "POST";
      body: zod24.ZodObject<{
        newPassword: zod24.ZodString;
      }, zod_v4_core7.$strip>;
    ...
    readonly updateUser: better_call14.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
      body: zod24.ZodRecord<zod24.ZodString, zod24.ZodAny>;
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
            id: string;
    ...
    readonly deleteUser: better_call14.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
      ...
      body: zod24.ZodObject<{
        callbackURL: zod24.ZodOptional<zod24.ZodString>;
        password: zod24.ZodOptional<zod24.ZodString>;
        token: zod24.ZodOptional<zod24.ZodString>;
      }, zod_v4_core7.$strip>;
      metadata: {
        openapi: {
    ...
    readonly requestPasswordReset: better_call14.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      body: zod24.ZodObject<{
        email: zod24.ZodEmail;
        redirectTo: zod24.ZodOptional<zod24.ZodString>;
      }, zod_v4_core7.$strip>;
      metadata: {
        openapi: {
          operationId: string;
    ...
    readonly requestPasswordResetCallback: better_call14.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: zod24.ZodObject<{
    ...
    readonly listSessions: better_call14.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call14.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: zod24.ZodObject<{
        token: zod24.ZodString;
      }, zod_v4_core7.$strip>;
    ...
    readonly revokeSessions: better_call14.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call14.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call14.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: zod24.ZodObject<{
        callbackURL: zod24.ZodOptional<zod24.ZodString>;
    ...
    readonly listUserAccounts: better_call14.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call14.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: zod24.ZodObject<{
        token: zod24.ZodString;
        callbackURL: zod24.ZodOptional<zod24.ZodString>;
    ...
    readonly unlinkAccount: better_call14.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: zod24.ZodObject<{
        providerId: zod24.ZodString;
        accountId: zod24.ZodOptional<zod24.ZodString>;
      }, zod_v4_core7.$strip>;
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly refreshToken: better_call14.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: zod24.ZodObject<{
        providerId: zod24.ZodString;
        accountId: zod24.ZodOptional<zod24.ZodString>;
        userId: zod24.ZodOptional<zod24.ZodString>;
      }, zod_v4_core7.$strip>;
      metadata: {
        openapi: {
          description: string;
    ...
    readonly getAccessToken: better_call14.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: zod24.ZodObject<{
        providerId: zod24.ZodString;
        accountId: zod24.ZodOptional<zod24.ZodString>;
    ...
    readonly accountInfo: better_call14.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call14.MiddlewareInputContext<better_call14.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
