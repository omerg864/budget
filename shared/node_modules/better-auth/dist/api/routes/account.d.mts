...
declare const listUserAccounts: better_call757.StrictEndpoint<"/list-accounts", {
  method: "GET";
  use: ((inputContext: better_call757.MiddlewareInputContext<better_call757.MiddlewareOptions>) => Promise<{
    session: {
...
declare const linkSocialAccount: better_call757.StrictEndpoint<"/link-social", {
  method: "POST";
  requireHeaders: true;
  body: z.ZodObject<{
...
declare const unlinkAccount: better_call757.StrictEndpoint<"/unlink-account", {
  method: "POST";
  body: z.ZodObject<{
...
declare const getAccessToken: better_call757.StrictEndpoint<"/get-access-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const refreshToken: better_call757.StrictEndpoint<"/refresh-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const accountInfo: better_call757.StrictEndpoint<"/account-info", {
  method: "GET";
  use: ((inputContext: better_call757.MiddlewareInputContext<better_call757.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
