...
declare const sendVerificationEmail: better_call779.StrictEndpoint<"/send-verification-email", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    email: z.ZodEmail;
...
declare const verifyEmail: better_call779.StrictEndpoint<"/verify-email", {
  method: "GET";
  operationId: string;
  query: z.ZodObject<{
    token: z.ZodString;
  ...
  use: ((inputContext: better_call779.MiddlewareInputContext<better_call779.MiddlewareOptions>) => Promise<void>)[];
  metadata: {
    openapi: {
      description: string;
      parameters: ({
