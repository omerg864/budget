...
import * as better_call784 from "better-call";
...
declare const signInSocial: <O extends BetterAuthOptions>() => better_call784.StrictEndpoint<"/sign-in/social", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const signInEmail: <O extends BetterAuthOptions>() => better_call784.StrictEndpoint<"/sign-in/email", {
  method: "POST";
  operationId: string;
  use: ((inputContext: better_call784.MiddlewareInputContext<better_call784.MiddlewareOptions>) => Promise<void>)[];
  body: z.ZodObject<{
    email: z.ZodString;
