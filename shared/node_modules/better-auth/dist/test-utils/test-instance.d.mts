...
import { InferErrorCodes, IsSignal } from "../client/types.mjs";
...
import * as better_call259 from "better-call";
...
declare function getTestInstance<O extends Partial<BetterAuthOptions>, C extends BetterAuthClientOptions>(options?: O | undefined, config?: {
  ...
  client: UnionToIntersection<(C extends undefined ? {} : C) & {
    ...
    readonly ok: better_call259.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call259.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call259.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
    ...
    readonly callbackOAuth: better_call259.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
    ...
    readonly getSession: better_call259.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: zod522.ZodOptional<zod522.ZodObject<{
    ...
    readonly signOut: better_call259.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call259.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<void>)[];
    ...
    readonly signInEmail: better_call259.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<void>)[];
      body: zod522.ZodObject<{
    ...
    readonly resetPassword: better_call259.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: zod522.ZodOptional<zod522.ZodObject<{
    ...
    readonly verifyPassword: better_call259.StrictEndpoint<"/verify-password", {
      method: "POST";
      body: zod522.ZodObject<{
        password: zod522.ZodString;
      }, zod_v4_core77.$strip>;
      ...
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly verifyEmail: better_call259.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
    ...
    readonly sendVerificationEmail: better_call259.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: zod522.ZodObject<{
        email: zod522.ZodEmail;
    ...
    readonly changeEmail: better_call259.StrictEndpoint<"/change-email", {
      method: "POST";
      body: zod522.ZodObject<{
    ...
    readonly changePassword: better_call259.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: zod522.ZodObject<{
        newPassword: zod522.ZodString;
    ...
    readonly setPassword: better_call259.StrictEndpoint<string, {
      method: "POST";
      body: zod522.ZodObject<{
        newPassword: zod522.ZodString;
      }, zod_v4_core77.$strip>;
    ...
    readonly updateUser: better_call259.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
    ...
    readonly deleteUser: better_call259.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly requestPasswordReset: better_call259.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      body: zod522.ZodObject<{
        email: zod522.ZodEmail;
    ...
    readonly requestPasswordResetCallback: better_call259.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: zod522.ZodObject<{
    ...
    readonly listSessions: better_call259.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call259.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: zod522.ZodObject<{
        token: zod522.ZodString;
      }, zod_v4_core77.$strip>;
    ...
    readonly revokeSessions: better_call259.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call259.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call259.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: zod522.ZodObject<{
        callbackURL: zod522.ZodOptional<zod522.ZodString>;
    ...
    readonly listUserAccounts: better_call259.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call259.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: zod522.ZodObject<{
        token: zod522.ZodString;
        callbackURL: zod522.ZodOptional<zod522.ZodString>;
    ...
    readonly unlinkAccount: better_call259.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: zod522.ZodObject<{
    ...
    readonly refreshToken: better_call259.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: zod522.ZodObject<{
        providerId: zod522.ZodString;
        accountId: zod522.ZodOptional<zod522.ZodString>;
    ...
    readonly getAccessToken: better_call259.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: zod522.ZodObject<{
        providerId: zod522.ZodString;
        accountId: zod522.ZodOptional<zod522.ZodString>;
    ...
    readonly accountInfo: better_call259.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call259.MiddlewareInputContext<better_call259.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
