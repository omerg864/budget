...
import * as _better_auth_core_db36 from "@better-auth/core/db";
...
declare const createFieldAttribute: <T extends DBFieldType, C extends DBFieldAttributeConfig>(type: T, config?: C | undefined) => {
  ...
  defaultValue?: (_better_auth_core_db36.DBPrimitive | (() => _better_auth_core_db36.DBPrimitive)) | undefined;
  onUpdate?: (() => _better_auth_core_db36.DBPrimitive) | undefined;
  transform?: {
    input?: (value: _better_auth_core_db36.DBPrimitive) => _better_auth_core39.Awaitable<_better_auth_core_db36.DBPrimitive>;
    output?: (value: _better_auth_core_db36.DBPrimitive) => _better_auth_core39.Awaitable<_better_auth_core_db36.DBPrimitive>;
  } | undefined;
  references?: {
    model: string;
    field: string;
